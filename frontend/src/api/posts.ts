...
export const postsApi = {
  getList: (page = 1, pageSize = 10) => client.get(`/posts?page=${page}&pageSize=${pageSize}`) as Promise<{ data: PostListResult }>,
  getBySlug: (slug: string) => client.get(`/posts/${slug}`) as Promise<{ data: Post }>,
  adminList: (page = 1, pageSize = 20) => client.get(`/admin/posts?page=${page}&pageSize=${pageSize}`) as Promise<{ data: PostListResult }>,
